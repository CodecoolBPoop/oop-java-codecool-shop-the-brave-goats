...
public class FilterSupplier extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String choosedSupplier = req.getParameter("supplier");
        ...
        context.setVariable("products", productDataStore.getBy(SupplierDaoMem.getInstance().findSupplier(choosedSupplier)));
